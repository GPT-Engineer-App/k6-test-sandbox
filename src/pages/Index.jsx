...
const Index = () => {
  ...
  useEffect(() => {
    document.title = "Pawsome Dogs | All About Dogs";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 text-center text-blue-800">Pawsome Dogs</h1>
          <p className="text-xl text-center text-gray-600 mb-8">Your ultimate guide to all things canine</p>
        </motion.div>
